        ...
        <main class="flex-grow flex flex-col max-w-[1400px] w-full mx-auto p-4 sm:p-6 lg:p-8 relative z-10 animate-fade-in-up">
            ...
            <div v-else>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <router-link to="/carteira" class="bg-[#151E2E] border border-slate-700 rounded-xl p-5 flex items-center gap-4 card-hover-effect group">
                            ...
                            <div class="flex-grow"><h3 class="text-white font-bold text-base mb-0.5">Minha Carteira</h3><p class="text-xs text-slate-400">Gerencie suas posições e lucros</p></div>
                            <i data-lucide="chevron-right"
                                class="w-5 h-5 text-slate-600 group-hover:text-prime-500 transition-colors"></i>
                        </router-link>
                        <router-link to="/conta-corrente" class="bg-[#151E2E] border border-slate-700 rounded-xl p-5 flex items-center gap-4 card-hover-effect group">
                            ...
                            <div class="flex-grow"><h3 class="text-white font-bold text-base mb-0.5">Conta Corrente</h3><p class="text-xs text-slate-400">Ver extrato e transfêrencias</p></div>
                            <i data-lucide="chevron-right"
                                class="w-5 h-5 text-slate-600 group-hover:text-prime-500 transition-colors"></i>
                        </router-link>
                    </div>
                ...
                <div class="mb-4 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div><h2 class="text-xl font-bold text-white flex items-center gap-2"><i data-lucide="star" class="w-5 h-5 text-prime-500"></i> Suas Maiores Posições</h2>
                    <p class="text-sm text-slate-400 mt-1">Os ativos com maior valor investido na sua carteira.</p>
                </div>
                    <router-link v-if="acoes.length > 0" to="/carteira" class="text-sm font-medium text-prime-500 hover:text-prime-400 flex items-center gap-1 group transition-colors">Ver carteira completa
